            ...
            <div class="pb-3 px-3">
                <form method="POST" action="{{ route('companies.update', $company->id) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-form.input id="vat" type="text" name="vat" :value="old('vat', $company->vat)" required />
                    </div>

                    <div class="mt-4">
                        <x-form.label for="type" :value="__('Tipul companiei')" />
                        <x-form.input id="type" type="number" name="type" :value="old('type', $company->type)" required />
                    </div>

                    <div class="mt-4">
                        <x-form.label for="with_contract" :value="__('Contract de colaborare')" />
                        <x-form.input id="with_contract" type="checkbox" name="with_contract" :checked="old('with_contract', $company->with_contract) ? true : false" required />
                    </div>
